...
class MobileController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        return $this->render('AppBundle:Mobile:layout/index.html.twig');
    }
    public function initiationAction()
    {

        return $this->render('AppBundle:Mobile:layout/initiation.html.twig');
    }
    public function locationAction()
    {

        return $this->render('AppBundle:Mobile:layout/location.html.twig');
    }
    public function randonneesAction()
    {

        return $this->render('AppBundle:Mobile:layout/randonnees.html.twig');
    }
    public function flyboardAction()
    {

        return $this->render('AppBundle:Mobile:layout/flyboard.html.twig');
    }
    public function flyfishAction()
    {

        return $this->render('AppBundle:Mobile:layout/flyfish.html.twig');
    }
    public function partenairesAction()
    {

        return $this->render('AppBundle:Mobile:layout/partenaires.html.twig');
    }
    public function photosAction()
    {

        return $this->render('AppBundle:Mobile:layout/galleriePhotos.html.twig');
    }
    public function pageTarifsAction()
    {

        return $this->render('AppBundle:Mobile:layout/pageTarifs.html.twig');
    }
        ...
        public function contactAction(Request $request)
    {
        ...
        return $this->render('AppBundle:Mobile:layout/contact.html.twig', array(
